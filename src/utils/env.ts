...
export default class ENV {
    ...
    public static STREET1 = process.env.APP_STREET1;
    public static NAMEADDEMERGANCYCONTACT = process.env.APP_NAMEADDEMERGANCYCONTACT;
    public static RELATIONSHIPADDEMERGANCYCONTACT = process.env.APP_RELATIONSHIPADDEMERGANCYCONTACT;
    public static MOBILEADDEMERGANCYCONTACT = process.env.APP_MOBILEADDEMERGANCYCONTACT;
