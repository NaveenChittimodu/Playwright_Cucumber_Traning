Feature: Fill the data in time page
  ...
  When Verify the user is able to search and retrieve Employee Attendance Records
  When Verify the user is able to enable and disable all the configuraiton option
  When Verify the user is able to search and retrieve project reports
  When Verify the user is able to search and retrieve employee reports
  When Verify the user is able to search and retrieve employee Attendance Summary
