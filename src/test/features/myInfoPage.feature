Feature: Fill the data in recruitment page
  ...
  Scenario:
    ...
    When User is able to fill the Email fields and user is able to save all the entered field values and verify the toast message - from step 23 to 24 
    ...
    When Verify the Job Details fields is filled with value and user is able to click on Include Employment Contract Details checkbox - from step 31 to 32
